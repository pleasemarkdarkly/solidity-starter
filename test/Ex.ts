...
import { Ex } from "../typechain/Ex"
import { shouldBehaveLikeEx } from "./Ex.behavior";
...
describe("Setup Admin and Unnamed Accounts", function () {
    ...
    describe("Creating Lottery Contract", function () {
        before(async function () {
            const exArtifact: Artifact = await hre.artifacts.readArtifact("Ex");
            this.ex = <Ex> await deployContract(this.signers.admin, exArtifact, []);
        });
